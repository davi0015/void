...
// Notification chime timbres. The names map to players in the sound script
// generated by VoidNotificationService (electron-main) — keep both lists in
// sync. Unknown values at runtime fall back to 'pop' there.
export const notificationSoundKinds = ['pop', 'glass', 'marimba', 'warmSynth', 'epiano', 'sparkle', 'kalimba', 'woodblock', 'waterdrop', 'sonar', 'bell', 'terminal'] as const
export type NotificationSoundKind = typeof notificationSoundKinds[number]
export const displayNameOfNotificationSoundKind: Record<NotificationSoundKind, string> = {
	pop: 'Pop',
	glass: 'Glass',
	marimba: 'Marimba',
...
export type GlobalSettings = {
	...
	// Notification chime timbre.
	notificationSoundKind: NotificationSoundKind;
