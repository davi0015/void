...
import { builtinToolNames, isABuiltinToolName, MAX_FILE_CHARS_PAGE, DEFAULT_TERMINAL_TIMEOUT_SECONDS, MAX_TERMINAL_TIMEOUT_SECONDS } from '../../../../common/prompt/prompts.js';
...
const toolNameToDesc = (toolName: BuiltinToolName, _toolParams: BuiltinToolCallParams[BuiltinToolName] | undefined, accessor: ReturnType<typeof useAccessor>): {
	...
	const x = {
		...
		'run_persistent_command': () => {
			...
			return {
				desc1: `"${toolParams.command}"`,
				desc1Info: toolParams.timeoutSeconds !== MAX_TERMINAL_TIMEOUT_SECONDS ? `${toolParams.timeoutSeconds}s timeout` : undefined,
			}
		},
